DROP FUNCTION IF EXISTS sf_rating_kos;
DELIMITER //
...
DROP FUNCTION IF EXISTS sf_kamar_tersedia_kota;
DELIMITER //
...
DROP FUNCTION IF EXISTS sf_pendapatan_bulan_ini;
DELIMITER //
...
DROP FUNCTION IF EXISTS sf_persentase_okupansi;
DELIMITER //
...
DROP FUNCTION IF EXISTS sf_total_pembayaran_penghuni;
DELIMITER //
...
DROP FUNCTION IF EXISTS sf_sisa_hari_kontrak;
DELIMITER //
...
DROP FUNCTION IF EXISTS sf_cek_kamar_tersedia;
DELIMITER //
...
DROP FUNCTION IF EXISTS sf_rata_durasi_sewa;
DELIMITER //
